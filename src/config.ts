...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    title: 'aBER\'s Blog',
    // site subtitle
    subtitle: 'Personal Blog & Study Notes',
    // site description
    description: 'aBER\'s Blog is a personal blog and study notes.',
  ...
  global: {
    ...
    moreLocales: ['ja', 'en'], // ['zh', 'zh-tw', 'ja', 'en', 'es', 'ru']
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'Twitter',
        url: 'https://x.com/aBER0724',
      },
      {
        name: 'Telegram',
        url: 'https://t.me/private_chat2aber_bot',
      },
      {
        name: 'Email',
        url: 'mailto:ab3r77724@gmail.com',
      }
    ],
